...
return  [
    'admin' => [
        'system' => [
            ...
            'cyber-source-payment-info' => 'Cybersource Payment Gateway es un módulo avanzado y rico en funciones que integrará su tienda con la pasarela de pago Cybersource.',    
        ],
    ...
    'shop' => [
        'payment' => [
            ...
            'title'        => 'Aceptación Segura - Forma de Pago',
        ],
    ],
];
