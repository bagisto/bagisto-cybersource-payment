...
return  [
    'admin' => [
        'system' => [
            ...
            'sandbox'                   => 'Sandkasten',
            'cyber-source-payment'      => 'CyberSource-Zahlung',
            'debug'                     => 'Debuggen',
            ...
            'cyber-source-payment-info' => 'Cybersource Payment Gateway ist ein fortschrittliches und funktionsreiches Modul, das Ihren Shop mit dem Cybersource Payment Gateway integriert',    
        ],

        'transaction' => [
            'error'  => 'Etwas ist schief gelaufen! Bitte versuche es erneut.',
            'cancel' => 'Transaktion abgebrochen',
        ],
    ],
